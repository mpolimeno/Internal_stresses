function [forceout,drag,drag_rot] = fractal_bi_stokes_force_trans_and_rot(xc,posint,ndir,ori,U_vec,Rot,Nf);
...
for kk = 1:Nf
	...
	v1 = Rot;
	v2 = (posint(kk,:) - cm)';
	Uvec = U_vec + cross(v1,v2); % velocity at the center of each face under translation and rotation
